...
const rules: ReviewRule[] = [
  ...
  { id: 'public-copy-guardrails-off', match: /Audience-aware copy guardrails are disabled for a customer-facing\/public product surface/i, severity: 'review', category: 'usability', title: 'Public copy guardrails are disabled', affectedSettings: ['content.publicCopyGuardrails'] },
